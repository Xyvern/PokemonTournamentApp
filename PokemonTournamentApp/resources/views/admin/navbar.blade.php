    ...
    <div class="container-fluid px-4 px-lg-5">
        ...
        <div class="collapse navbar-collapse" id="navbarContent">
            ...
            <ul class="navbar-nav ml-auto align-items-center">
                ...
                {{-- Navigation Links --}}
                <li class="nav-item">
                    <a href="{{ route('admin.archetypes.index') }}" class="nav-link px-3 {{ request()->routeIs('admin.archetypes.*') ? 'active font-weight-bold text-white' : '' }}">
                        Archetypes
                    </a>
                </li>
                <li class="nav-item">
                    <a href="{{ route('admin.tournaments.index') }}" class="nav-link px-3 {{ request()->routeIs('admin.tournaments.*') ? 'active font-weight-bold text-white' : '' }}">
                        Tournaments
                    </a>
                </li>
                <li class="nav-item">
                    <a href="{{ route('admin.players.index') }}" class="nav-link px-3 {{ request()->routeIs('admin.players.*') ? 'active font-weight-bold text-white' : '' }}">
                        Players
                    </a>
                </li>
                <li class="nav-item">
                ...
                <li class="nav-item">
                    <a href="{{ route('admin.cards.index') }}" class="nav-link px-3 {{ request()->routeIs('admin.cards.*') ? 'active font-weight-bold text-white' : '' }}">
                        Card Database
                    </a>
                </li>
                {{-- Divider for Desktop --}}
