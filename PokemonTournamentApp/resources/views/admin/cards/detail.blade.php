    ...
    <div class="card-detail-grid">
        ...
        <div class="left-panel">
            ...
            <div class="meta-data">
                ...
                {{-- NEW: Playable Status Badge --}}
                <div class="meta-row">
                    <span class="meta-label">Status</span>
                    <span class="meta-value">
                        @if($card->is_playable)
                            <span class="badge badge-success px-2 py-1">Playable</span>
                        @else
                            <span class="badge badge-danger px-2 py-1">Not Playable</span>
                        @endif
                    </span>
                </div>
            </div>
            ...
            <div class="mt-4 w-100" style="max-width: 420px;">
                <form action="{{ route('admin.cards.togglePlayable', $card->id) }}" method="POST">
                    @csrf
                    <button type="submit" class="btn btn-block font-weight-bold shadow-sm {{ $card->is_playable ? 'btn-outline-danger' : 'btn-success' }}">
                        <i class="fas {{ $card->is_playable ? 'fa-ban' : 'fa-check-circle' }} mr-1"></i>
                        {{ $card->is_playable ? 'Mark as Not Playable' : 'Mark as Playable' }}
                    </button>
                </form>
            </div>
        </div>
