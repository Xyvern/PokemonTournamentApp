            ...
            <div class="card shadow-sm border-0">
                <div class="card-body">
                    <div class="row align-items-center">
                        ...
                        <div class="col-md-7 text-md-right mt-3 mt-md-0 d-flex justify-content-md-end align-items-center flex-wrap">
                            <div class="btn-group shadow-sm mr-3 mb-2 mb-md-0" role="group">
                            ...
                            {{-- NEW: Create Tournament Button --}}
                            <a href="{{ route('admin.tournaments.create') }}" class="btn btn-primary font-weight-bold shadow-sm mb-2 mb-md-0">
                                <i class="fas fa-plus-circle mr-1"></i> Create Tournament
                            </a>
                        </div>
                    </div>
                </div>
                    ...
                    <table id="tournamentsTable" class="table table-bordered table-striped table-hover">
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td class="align-middle text-center">
                                    <a href="{{ route('admin.tournaments.detail', ['id' => $tournament->id]) }}" class="btn btn-sm btn-outline-primary font-weight-bold">
